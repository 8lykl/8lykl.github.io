...
const overlayContents = document.getElementsByClassName('overlay-content');
...
function scalePage() {
  ...
  for (let i = 0; i < overlayContents.length; i++) {
    overlayContents[i].style.transform = `scale(${scale})`;
    overlayContents[i].style.transformOrigin = 'top left';
  }
